...
clear = Button(btns_frame, text = "C", fg = "black", width = 33, height = 3, bd = 0, bg = "white", cursor = "hand2", command = lambda: bt_clear()).grid(row = 0, column = 0, columnspan = 3, padx = 1, pady = 1)
...
seven = Button(btns_frame, text = "7", fg = "black", width = 11, height = 3, bd = 0, bg = "white", cursor = "hand2", command = lambda: btn_click(7)).grid(row = 1, column = 0, padx = 1, pady = 1)
...
four = Button(btns_frame, text = "4", fg = "black", width = 11, height = 3, bd = 0, bg = "white", cursor = "hand2", command = lambda: btn_click(4)).grid(row = 2, column = 0, padx = 1, pady = 1)
...
one = Button(btns_frame, text = "1", fg = "black", width = 11, height = 3, bd = 0, bg = "white", cursor = "hand2", command = lambda: btn_click(1)).grid(row = 3, column = 0, padx = 1, pady = 1)
...
zero = Button(btns_frame, text = "0", fg = "black", width = 22, height = 3, bd = 0, bg = "white", cursor = "hand2", command = lambda: btn_click(0)).grid(row = 4, column = 0, columnspan = 2, padx = 1, pady = 1)
